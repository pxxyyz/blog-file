    ...
    carousel: function a(d) {
      ...
      var o = {
        ...
        cloneItem: function s() {
          var w = c
            .find(".swiper-item:not(:first-child)")
            .clone()
            .addClass("cloned");
          var x = c
            .find(".swiper-item:not(:last-child)")
            .clone()
            .addClass("cloned");
        ...
        prev: function g() {
          ...
          m = setTimeout(function () {
            ...
            if (y !== 1) {
              ...
              E.css(
                "transform",
                "translate3d(-".concat(k * --y, "px, 0px, 0px)")
              );
            } else {
              ...
              E.css(
                "transform",
                "translate3d(-".concat(k * G, "px, 0px, 0px)")
              );
              setTimeout(function () {
            ...
            if (!w) {
              z.removeClass("swiper-pagination-item_active")
                .eq(C - 1)
                .addClass("swiper-pagination-item_active");
            } else {
              D.removeClass("swiper-pagination-item_active")
                .prev()
                .addClass("swiper-pagination-item_active");
            }
            A.autoPlay();
